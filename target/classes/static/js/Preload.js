...
AsiloRoyale.Preload.prototype = {
	...
	preload : function() {
		...
		// Preload de assets
		this.load.tilemap('level1', 'assets/tilemaps/untitled.json', null,
		...
		this.load.image('cartucho_escopeta',
				'assets/images/cartucho_escopeta.png');
		...
		this.load.image('tabla_conectados',
				'assets/images/tabla_conectados.png');
		this.load.spritesheet('botonesjugar',
				'assets/images/offlinebutton.png', 256, 128, 2);
		this.load.spritesheet('okbutton', 'assets/images/okbutton.png', 128,
				128, 2);
		this.load.spritesheet('onlinebutton', 'assets/images/onlinebutton.png',
				256, 128, 2);
		this.load.spritesheet('readybutton', 'assets/images/readybutton.png',
				256, 128, 2);
		this.load.spritesheet('botonessalir', 'assets/images/exitbutton.png',
				256, 128, 2);
		this.load.spritesheet('dientes', 'assets/images/dientes.png', 32, 32);
		this.load.spritesheet('dientes', 'assets/images/dientes.png', 32, 32);
		this.load.spritesheet('enfermero', 'assets/images/enfermero.png', 128,
				128);
		this.load.spritesheet('player', 'assets/images/viejo1_sheet.png', 126,
				64);
		this.load.spritesheet('iconos_municion',
				'assets/images/iconos_municion.png', 40, 40);
		this.load.image('serveroff', 'assets/images/serveroff.png');
		this.load.image('star', 'assets/images/star.png');
		this.load.image('letrasgameover', 'assets/images/gameover.jpg', 256,
				128, 2);
		...
		this.game.load.physics('player_physics',
				'assets/physics/viejo_physics.json');
